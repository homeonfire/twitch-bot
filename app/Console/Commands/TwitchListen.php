            ...
            $response = Http::withToken(env('DEEPSEEK_API_KEY'))
                ...
                ->post('https://api.deepseek.com/chat/completions', [
                    ...
                    'messages' => [
                        [
                            'role' => 'system',
                            'content' => 'Ты помощник на Twitch. Стример играет разные игры и общается. Отвечай зрителям коротко (до 2 предложений), живо, с юмором, как любой чаттерс на твиче, используй нецензурные выражения.'
                        ],
                        [
                            'role' => 'user',
